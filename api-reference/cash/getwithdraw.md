...
```text
GET https://api.coolsms.co.kr/cash/v1/withdraw
```
...
```text
http://api.coolsms.co.kr/cash/v1/withdraw
```
...
uri = URI.parse("http://api.coolsms.co.kr/cash/v1/withdraw")
...
func main() {
  uri := "http://api.coolsms.co.kr/cash/v1/withdraw"
...
public class Request {
  public static void main(String[] args) throws Exception {
    String targetUrl = "http://api.coolsms.co.kr/cash/v1/withdraw";
