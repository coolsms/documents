...
## Request
```
POST https://api.coolsms.co.kr/cash/v1/company
```
...
var options = {
  ...
  method: 'POST',
  json: true,
  url: 'http://api.coolsms.co.kr/cash/v1/company'
};
...
curl -X POST \
	...
	http://api.coolsms.co.kr/cash/v1/company
```
{% endtab %}
...
uri = URI.parse("http://api.coolsms.co.kr/cash/v1/company")
...
func main() {
  uri := "http://api.coolsms.co.kr/cash/v1/company"
...
public class Request {
  public static void main(String[] args) throws Exception {
    String targetUrl = "http://api.coolsms.co.kr/cash/v1/company";
