...
```text
PUT https://api.coolsms.co.kr/cash/v1/balance/alert
```
...
var options = {
  ...
  method: 'PUT',
  json: true,
  url: 'http://api.coolsms.co.kr/cash/v1/balance/alert'
};
...
curl -X PUT \
    ...
    http://api.coolsms.co.kr/cash/v1/balance/alert
```
{% endtab %}
...
uri = URI.parse("http://api.coolsms.co.kr/cash/v1/balance/alert")
...
func main() {
  uri := "http://api.coolsms.co.kr/cash/v1/balance/alert"
...
public class Request {
  public static void main(String[] args) throws Exception {
    String targetUrl = "http://api.coolsms.co.kr/cash/v1/balance/alert";
