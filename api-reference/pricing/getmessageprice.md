...
```text
GET https://api.coolsms.co.kr/pricing/v1/messaging
```
...
```text
http://api.coolsms.co.kr/pricing/v1/messaging
```
...
var options = {
  ...
  method: 'GET',
  json: true,
  url: 'http://api.coolsms.co.kr/pricing/v1/messaging'
};
...
uri = URI.parse("http://api.coolsms.co.kr/pricing/v1/messaging")
...
func main() {
  uri := "http://api.coolsms.co.kr/pricing/v1/messaging"
...
public class Request {
  public static void main(String[] args) throws Exception {
    String targetUrl = "http://api.coolsms.co.kr/pricing/v1/messaging";
