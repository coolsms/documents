...
var options = {
  ...
  json: true,
  url:
    'http://api.coolsms.co.kr/appstore/v2/me/apps/dMuHVUkTfoqL/images/screenshots'
};
...
```php
<?php
$url = "http://api.coolsms.co.kr/appstore/v2/me/apps/dMuHVUkTfoqL/images/screenshots";
...
uri = URI.parse("http://api.coolsms.co.kr/appstore/v2/me/apps/dMuHVUkTfoqL/images/screenshots")
...
func main() {
  uri := "http://api.coolsms.co.kr/appstore/v2/me/apps/dMuHVUkTfoqL/images/screenshots"
...
public class Request {
  public static void main(String[] args) throws Exception {
    String targetUrl = "http://api.coolsms.co.kr/appstore/v2/me/apps/dMuHVUkTfoqL/images/screenshots";
