...
```javascript
{
    ...
    "appId": "WJ5ExxSCo8pD",
    "dateCreated": "2020-09-23T03:11:28.034Z",
    "dateUpdated": "2020-09-23T03:11:28.040Z"
}
```
...
var options = {
  ...
  method: 'PUT',
  json: true,
  url: 'http://api.coolsms.co.kr/appstore/v2/me/apps/WJ5ExxSCo8pD/stage'
};
...
curl -X PUT \
    ...
    http://api.coolsms.co.kr/appstore/v2/me/apps/WJ5ExxSCo8pD/stage
```
{% endtab %}
...
uri = URI.parse("http://api.coolsms.co.kr/appstore/v2/me/apps/WJ5ExxSCo8pD/stage")
...
func main() {
  uri := "http://api.coolsms.co.kr/appstore/v2/me/apps/WJ5ExxSCo8pD/stage"
...
public class Request {
  public static void main(String[] args) throws Exception {
    String targetUrl = "http://api.coolsms.co.kr/appstore/v2/me/apps/WJ5ExxSCo8pD/stage";
