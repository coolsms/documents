...
{% api-method method="delete" host="https://api.coolsms.co.kr" path="/messages/v4/groups/{groupId}" %}
{% api-method-summary %}
deleteMessageGroup
...
{% tab title="CURL" %}
```bash
curl -X DELETE https://api.coolsms.co.kr/messages/v4/groups/G4V20180307105937H3PTASXMNJG2JIO
