...
{% api-method method="get" host="https://api.coolsms.co.kr" path="/messages/v4/groups/{groupId}" %}
{% api-method-summary %}
getMessageGroupInfo
...
{% tab title="CURL" %}
```bash
curl -X GET https://api.coolsms.co.kr/messages/v4/groups/G4V20180307105937H3PTASXMNJG2JIO
