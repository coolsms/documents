...
## Request
```
GET https://api.coolsms.co.kr/messages/v4/groups/excel
```
...
```
http://api.coolsms.co.kr/messages/v4/groups/excel?criteria=dateCreated&value=2021-07-14%2016:04:17&cond=lt&limit=25
```
...
```php
<?php
$url = "http://api.coolsms.co.kr/messages/v4/groups/excel?criteria=dateCreated&value=2021-07-14%2016:04:17&cond=lt&limit=25";
...
uri = URI.parse("http://api.coolsms.co.kr/messages/v4/groups/excel?criteria=dateCreated&value=2021-07-14%2016:04:17&cond=lt&limit=25")
...
func main() {
  uri := "http://api.coolsms.co.kr/messages/v4/groups/excel?criteria=dateCreated&value=2021-07-14%2016:04:17&cond=lt&limit=25"
...
public class Request {
  public static void main(String[] args) throws Exception {
    String targetUrl = "http://api.coolsms.co.kr/messages/v4/groups/excel?criteria=dateCreated&value=2021-07-14%2016:04:17&cond=lt&limit=25";
