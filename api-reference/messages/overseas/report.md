...
uri = URI.parse("http://api.coolsms.co.kr/messages/v4/overseas/report")
...
func main() {
  uri := "http://api.coolsms.co.kr/messages/v4/overseas/report"
...
public class Request {
  public static void main(String[] args) throws Exception {
    String targetUrl = "http://api.coolsms.co.kr/messages/v4/overseas/report";
