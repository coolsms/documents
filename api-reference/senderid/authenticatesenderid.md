...
```text
PUT https://api.coolsms.co.kr/senderid/v1/numbers/:phoneNumber/authenticate
```
...
var options = {
  ...
  method: 'PUT',
  json: true,
  url: 'http://api.coolsms.co.kr/senderid/v1/numbers/01000000000/authenticate'
};
...
curl -X PUT \
    ...
    http://api.coolsms.co.kr/senderid/v1/numbers/01000000000/authenticate
```
{% endtab %}
...
uri = URI.parse("http://api.coolsms.co.kr/senderid/v1/numbers/01000000000/authenticate")
...
func main() {
  uri := "http://api.coolsms.co.kr/senderid/v1/numbers/01000000000/authenticate"
...
public class Request {
  public static void main(String[] args) throws Exception {
    String targetUrl = "http://api.coolsms.co.kr/senderid/v1/numbers/01000000000/authenticate";
