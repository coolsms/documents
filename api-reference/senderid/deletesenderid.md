...
```text
DELETE https://api.coolsms.co.kr/senderid/v1/numbers/:phoneNumber
```
...
var options = {
  ...
  method: 'DELETE',
  json: true,
  url: 'http://api.coolsms.co.kr/senderid/v1/numbers/01000000000'
};
...
curl -X DELETE \
    ...
    http://api.coolsms.co.kr/senderid/v1/numbers/01000000000
```
{% endtab %}
...
uri = URI.parse("http://api.coolsms.co.kr/senderid/v1/numbers/01000000000")
...
func main() {
  uri := "http://api.coolsms.co.kr/senderid/v1/numbers/01000000000"
...
public class Request {
  public static void main(String[] args) throws Exception {
    String targetUrl = "http://api.coolsms.co.kr/senderid/v1/numbers/01000000000";
