...
```text
POST https://api.coolsms.co.kr/senderid/v1/papers/limitation
```
...
var options = {
  ...
  method: 'POST',
  json: true,
  url: 'http://api.coolsms.co.kr/senderid/v1/papers/limitation'
};
...
curl -X POST \
    ...
    http://api.coolsms.co.kr/senderid/v1/papers/limitation
```
{% endtab %}
...
uri = URI.parse("http://api.coolsms.co.kr/senderid/v1/papers/limitation")
...
func main() {
  uri := "http://api.coolsms.co.kr/senderid/v1/papers/limitation"
...
public class Request {
  public static void main(String[] args) throws Exception {
    String targetUrl = "http://api.coolsms.co.kr/senderid/v1/papers/limitation";
