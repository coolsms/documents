...
```text
POST https://api.coolsms.co.kr/images/v4/images
```
...
var options = {
  ...
  method: 'POST',
  json: true,
  url: 'http://api.coolsms.co.kr/images/v4/images'
};
...
curl -X POST \
    ...
    http://api.coolsms.co.kr/images/v4/images
```
{% endtab %}
...
uri = URI.parse("http://api.coolsms.co.kr/images/v4/images")
...
func main() {
  uri := "http://api.coolsms.co.kr/images/v4/images"
...
public class Request {
  public static void main(String[] args) throws Exception {
    String targetUrl = "http://api.coolsms.co.kr/images/v4/images";
