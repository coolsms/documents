...
```text
POST https://api.coolsms.co.kr/kakao/v1/plus-friends/:service
```

기존에 등록된 카카오톡채널을 COOLSMS에 연동합니다.
...
var options = {
  ...
  method: 'POST',
  json: true,
  url: 'http://api.coolsms.co.kr/kakao/v1/plus-friends/daou'
};
...
curl -X POST \
    ...
    http://api.coolsms.co.kr/kakao/v1/plus-friends/daou
```
{% endtab %}
...
uri = URI.parse("http://api.coolsms.co.kr/kakao/v1/plus-friends/daou")
...
func main() {
  uri := "http://api.coolsms.co.kr/kakao/v1/plus-friends/daou"
...
public class Request {
  public static void main(String[] args) throws Exception {
    String targetUrl = "http://api.coolsms.co.kr/kakao/v1/plus-friends/daou";
