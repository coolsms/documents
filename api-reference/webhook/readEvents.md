...
## Request
```
GET https://api.coolsms.co.kr/webhook/v1/events
```
...
```
http://api.coolsms.co.kr/webhook/v1/events?
```
...
var options = {
  ...
  method: 'GET',
  json: true,
  url: 'http://api.coolsms.co.kr/webhook/v1/events?'
};
...
uri = URI.parse("http://api.coolsms.co.kr/webhook/v1/events?")
...
func main() {
  uri := "http://api.coolsms.co.kr/webhook/v1/events?"
...
public class Request {
  public static void main(String[] args) throws Exception {
    String targetUrl = "http://api.coolsms.co.kr/webhook/v1/events?";
