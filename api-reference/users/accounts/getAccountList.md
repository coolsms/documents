...
uri = URI.parse("http://api.coolsms.co.kr/users/v1/accounts?limit=3")
...
func main() {
  uri := "http://api.coolsms.co.kr/users/v1/accounts?limit=3"
...
public class Request {
  public static void main(String[] args) throws Exception {
    String targetUrl = "http://api.coolsms.co.kr/users/v1/accounts?limit=3";
